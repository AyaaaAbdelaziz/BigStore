								...
								<a href="#" data-toggle="modal" data-target="#myModal" class="offer-img">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add add-2">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="<?php echo e($product->id); ?>" data-name="<?php echo e($product->name); ?>" data-summary="<?php echo e($product->description); ?>" data-price="<?php echo e($product->price); ?>" data-quantity="<?php echo e($product->quantity); ?>" data-image="<?php echo e($product->photo); ?>">Add to Cart</button>
										</div>
									</div>
									</div>
